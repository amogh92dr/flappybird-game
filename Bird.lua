...
function Bird:init()
  self.image = love.graphics.newImage('asset/image/bird.png')
  self.x = VIRTUAL_WIDTH / 2 - 8
  self.y = VIRTUAL_HEIGHT / 2 - 8

  self.width = 3 * self.image:getWidth() / 4
  self.height = 3 * self.image:getHeight() / 4
...
function Bird:render()
  love.graphics.draw(self.image, self.x, self.y, 0, 0.75, 0.75)
end
