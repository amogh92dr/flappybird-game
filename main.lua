...
local ground = love.graphics.newImage('asset/image/ground.png')
...
function love.load()
  ...
  -- app window title
  love.window.setTitle('FlappyBird (0.0)')

  -- initialize our nice-looking retro text fonts
  smallFont = love.graphics.newFont('asset/font/font.ttf', 8)
  ...
  sounds = {
    ['jump'] = love.audio.newSource('asset/sound/jump.wav', 'static'),
